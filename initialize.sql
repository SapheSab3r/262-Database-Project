...
\copy Jobs(jobID, name, level, salary, location, requirement, description, companyID, notificationID) FROM data/job_posts.csv csv header;
...
\copy Saved_Jobs(uID, jobID) FROM data/saved_jobs.csv csv header;
